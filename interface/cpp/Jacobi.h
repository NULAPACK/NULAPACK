...
fortran API_zgejsv(INTEGER* N, DOUBLE_COMPLEX* A, DOUBLE_COMPLEX* B, DOUBLE_COMPLEX* X,
    ...
    /**
     * @brief Jacobi iterative solver for A * X = B.
     *
     * Solves the linear system A * X = B using the iterative Jacobi method
     * with optional relaxation. A is a square N x N matrix in flat row-major
     * array format.
     *
     ...
     * @param[in]     OMEGA    Relaxation factor (default = 1.0, i.e. standard Jacobi).
     */
    ...
    /**
     * @overload
     * @brief Jacobi iterative solver (double-precision).
     *
     * @param[in]     N        Pointer to the size of the matrix (N x N).
     * @param[in]     A        Flat row-major input matrix of size N*N.
     * @param[in]     B        Right-hand side vector of size N.
    ...
    /**
     * @overload
     * @brief Jacobi iterative solver (single-precision complex).
     *
     * @param[in]     N        Pointer to the size of the matrix (N x N).
     * @param[in]     A        Flat row-major input matrix of size N*N.
     * @param[in]     B        Right-hand side vector of size N.
    ...
    /**
     * @overload
     * @brief Jacobi iterative solver (double-precision complex).
     *
     * @param[in]     N        Pointer to the size of the matrix (N x N).
     * @param[in]     A        Flat row-major input matrix of size N*N.
     * @param[in]     B        Right-hand side vector of size N.
