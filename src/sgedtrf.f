...
C
C     ====================================================================
C       SGEDTRF  -  Doolittle Factorization for A = L * U
C     ====================================================================
C       Description:
C       ------------------------------------------------------------------
...
C         A(*)   : REAL               -> flat row-major matrix A
C         L(*)   : REAL               -> lower triangular matrix L
C         U(*)   : REAL               -> upper triangular matrix U
C         INFO   : INTEGER            -> return code:
C                                           0 = success
C                                          <0 = zero diagonal in U detected
C     ====================================================================
      SUBROUTINE SGEDTRF(N, A, L, U, INFO)
