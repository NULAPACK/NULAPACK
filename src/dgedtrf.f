...
C
C     ====================================================================
C       DGEDTRF  -  Doolittle Factorization for A = L * U
C     ====================================================================
C       Description:
C       ------------------------------------------------------------------
...
C         A(*)   : DOUBLE PRECISION   -> flat row-major matrix A
C         L(*)   : DOUBLE PRECISION   -> lower triangular matrix L
C         U(*)   : DOUBLE PRECISION   -> upper triangular matrix U
C         INFO   : INTEGER            -> return code:
C                                           0 = success
C                                          <0 = zero diagonal in U detected
C     ====================================================================
      SUBROUTINE DGEDTRF(N, A, L, U, INFO)
